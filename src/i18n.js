(function exposeInfiniteLofiI18n(globalScope) {
  ...
  const ENGLISH = Object.freeze({
    ...
    "reader.open": "Open reading mode",
    "reader.close": "Close reading mode",
    "reader.eyebrow": "Local Reader",
    "reader.title": "Reading Mode",
    "reader.filter": "Filter documents",
    "reader.filterPlaceholder": "Filter by name…",
    "reader.chooseFolder": "Choose reading folder",
    "reader.refresh": "Refresh",
    "reader.mediaFolder": "Current media folder",
    "reader.readingFolder": "Reading folder",
    "reader.findPlaceholder": "Find in document…",
    "reader.textSize": "Text size",
    "reader.widthNarrow": "Narrow",
    "reader.widthMedium": "Medium",
    "reader.widthWide": "Wide",
    "reader.themeAuto": "Auto",
    "reader.themePaper": "Paper",
    "reader.themeDark": "Dark",
    "reader.emptyTitle": "Choose a document",
    "reader.emptyHint": "Text stays on this device and opens read-only.",
    "reader.noDocuments": "No supported documents",
    "reader.scanning": "Scanning local documents…",
    "reader.documentCount": "{count} documents · local and read-only",
    "reader.scanTruncated": "The safety scan limit was reached; showing the first supported documents.",
    "reader.folderUnavailable": "This folder is unavailable. Reconnect it to continue reading.",
    "reader.scanError": "The folder could not be scanned safely.",
    "reader.loading": "Opening document…",
    "reader.encodingError": "The document encoding could not be identified reliably.",
    "reader.readError": "This document could not be read.",
    "reader.invalidJson": "Invalid JSON · shown as original text",
    "reader.miniUnavailable": "Return to full view before opening Reader.",
    ...
    "player.videoPreparing": "Preparing a compatible copy… {percent}%",
    "player.clearVideoCache": "Clear compatibility cache",
    "player.videoCacheCleared": "Video compatibility cache cleared.",
  ...
  Object.assign(TRANSLATIONS["zh-CN"], {
    "common.cancel":"取消","nav.read":"阅读","reader.open":"打开阅读模式","reader.close":"关闭阅读模式","reader.eyebrow":"本地阅读器","reader.title":"阅读模式","reader.filter":"筛选文档","reader.filterPlaceholder":"按名称筛选……","reader.chooseFolder":"选择阅读文件夹","reader.refresh":"刷新","reader.mediaFolder":"当前媒体文件夹","reader.readingFolder":"阅读文件夹","reader.findPlaceholder":"在文档中查找……","reader.textSize":"字号","reader.widthNarrow":"窄","reader.widthMedium":"中","reader.widthWide":"宽","reader.themeAuto":"自动","reader.themePaper":"纸张","reader.themeDark":"深色","reader.emptyTitle":"选择一个文档","reader.emptyHint":"文本只在本机以只读方式打开。","reader.noDocuments":"没有支持的文档","reader.scanning":"正在扫描本地文档……","reader.documentCount":"{count} 个文档 · 本地只读","reader.scanTruncated":"已达到安全扫描上限，仅显示前面的支持文档。","reader.folderUnavailable":"文件夹不可用，请重新连接。","reader.scanError":"无法安全扫描此文件夹。","reader.loading":"正在打开文档……","reader.encodingError":"无法可靠识别文档编码。","reader.readError":"无法读取此文档。","reader.invalidJson":"JSON 无效 · 已显示原始文本","reader.miniUnavailable":"请先返回完整模式再打开阅读器。","player.folderUnsupported":"不支持选择本地媒体文件夹。","player.noMusicFiles":"所选文件夹中未找到支持的音频或视频文件。","player.videoBackground":"视频背景","player.videoBackgroundHint":"在专注界面背后显示当前视频。","player.videoBadge":"视频","player.mediaPlaybackError":"无法播放此视频；文件可能损坏、受 DRM 保护或无法解码。","player.videoDisplaySaveError":"无法保存视频显示偏好。","player.videoBackgroundEnabled":"当前视频已显示为背景。","player.videoBackgroundDisabled":"当前视频将仅播放音频。","player.videoPreparing":"正在准备兼容副本……{percent}%","player.clearVideoCache":"清除兼容缓存","player.videoCacheCleared":"视频兼容缓存已清除。"
  });
  Object.assign(JAPANESE, {
    "common.cancel":"キャンセル","nav.read":"読む","reader.open":"読書モードを開く","reader.close":"読書モードを閉じる","reader.eyebrow":"ローカルリーダー","reader.title":"読書モード","reader.filter":"文書を絞り込む","reader.filterPlaceholder":"名前で絞り込み…","reader.chooseFolder":"読書フォルダを選択","reader.refresh":"更新","reader.mediaFolder":"現在のメディアフォルダ","reader.readingFolder":"読書フォルダ","reader.findPlaceholder":"文書内を検索…","reader.textSize":"文字サイズ","reader.widthNarrow":"狭い","reader.widthMedium":"標準","reader.widthWide":"広い","reader.themeAuto":"自動","reader.themePaper":"紙","reader.themeDark":"ダーク","reader.emptyTitle":"文書を選択","reader.emptyHint":"テキストは端末内で読み取り専用で開きます。","reader.noDocuments":"対応文書がありません","reader.scanning":"ローカル文書をスキャン中…","reader.documentCount":"{count} 件 · ローカル／読み取り専用","reader.scanTruncated":"安全上のスキャン上限に達したため、先頭の対応文書のみ表示します。","reader.folderUnavailable":"このフォルダは利用できません。再接続してください。","reader.scanError":"フォルダを安全にスキャンできませんでした。","reader.loading":"文書を開いています…","reader.encodingError":"文書の文字コードを確実に判定できません。","reader.readError":"文書を読み込めません。","reader.invalidJson":"無効な JSON · 元のテキストを表示","reader.miniUnavailable":"Reader を開く前に全画面表示へ戻ってください。","player.folderUnsupported":"ローカルメディアフォルダーの選択には対応していません。","player.noMusicFiles":"選択したフォルダーに対応する音声または動画ファイルがありません。","player.videoBackground":"動画を背景に表示","player.videoBackgroundHint":"現在の動画を集中画面の背景に表示します。","player.videoBadge":"動画","player.mediaPlaybackError":"この動画を再生できません。破損、DRM、またはデコード不能の可能性があります。","player.videoDisplaySaveError":"動画表示設定を保存できませんでした。","player.videoBackgroundEnabled":"現在の動画を背景に表示します。","player.videoBackgroundDisabled":"現在の動画は音声のみ再生します。","player.videoPreparing":"互換コピーを準備中… {percent}%","player.clearVideoCache":"互換キャッシュを消去","player.videoCacheCleared":"動画互換キャッシュを消去しました。"
  });
  Object.assign(FRENCH, {
    "common.cancel":"Annuler","nav.read":"Lire","reader.open":"Ouvrir le mode lecture","reader.close":"Fermer le mode lecture","reader.eyebrow":"Lecteur local","reader.title":"Mode lecture","reader.filter":"Filtrer les documents","reader.filterPlaceholder":"Filtrer par nom…","reader.chooseFolder":"Choisir un dossier de lecture","reader.refresh":"Actualiser","reader.mediaFolder":"Dossier multimédia actuel","reader.readingFolder":"Dossier de lecture","reader.findPlaceholder":"Rechercher dans le document…","reader.textSize":"Taille du texte","reader.widthNarrow":"Étroite","reader.widthMedium":"Moyenne","reader.widthWide":"Large","reader.themeAuto":"Auto","reader.themePaper":"Papier","reader.themeDark":"Sombre","reader.emptyTitle":"Choisissez un document","reader.emptyHint":"Le texte reste sur cet appareil et s’ouvre en lecture seule.","reader.noDocuments":"Aucun document pris en charge","reader.scanning":"Analyse des documents locaux…","reader.documentCount":"{count} documents · locaux et en lecture seule","reader.scanTruncated":"La limite d’analyse sécurisée est atteinte ; seuls les premiers documents compatibles sont affichés.","reader.folderUnavailable":"Ce dossier est indisponible. Reconnectez-le pour continuer.","reader.scanError":"Impossible d’analyser ce dossier en toute sécurité.","reader.loading":"Ouverture du document…","reader.encodingError":"Impossible d’identifier l’encodage de façon fiable.","reader.readError":"Impossible de lire ce document.","reader.invalidJson":"JSON non valide · texte original affiché","reader.miniUnavailable":"Revenez à l’affichage complet avant d’ouvrir Reader.","player.folderUnsupported":"La sélection d’un dossier multimédia local n’est pas prise en charge.","player.noMusicFiles":"Aucun fichier audio ou vidéo compatible n’a été trouvé dans le dossier choisi.","player.videoBackground":"Vidéo en arrière-plan","player.videoBackgroundHint":"Afficher cette vidéo derrière l’interface de concentration.","player.videoBadge":"Vidéo","player.mediaPlaybackError":"Impossible de lire cette vidéo : elle est peut-être endommagée, protégée par DRM ou indécodable.","player.videoDisplaySaveError":"Impossible d’enregistrer la préférence d’affichage vidéo.","player.videoBackgroundEnabled":"La vidéo actuelle est affichée en arrière-plan.","player.videoBackgroundDisabled":"La vidéo actuelle continue en audio uniquement.","player.videoPreparing":"Préparation d’une copie compatible… {percent} %","player.clearVideoCache":"Vider le cache de compatibilité","player.videoCacheCleared":"Cache de compatibilité vidéo vidé."
  });
  Object.assign(KOREAN, {
    "common.cancel":"취소","nav.read":"읽기","reader.open":"읽기 모드 열기","reader.close":"읽기 모드 닫기","reader.eyebrow":"로컬 리더","reader.title":"읽기 모드","reader.filter":"문서 필터","reader.filterPlaceholder":"이름으로 필터…","reader.chooseFolder":"읽기 폴더 선택","reader.refresh":"새로 고침","reader.mediaFolder":"현재 미디어 폴더","reader.readingFolder":"읽기 폴더","reader.findPlaceholder":"문서에서 찾기…","reader.textSize":"글자 크기","reader.widthNarrow":"좁게","reader.widthMedium":"보통","reader.widthWide":"넓게","reader.themeAuto":"자동","reader.themePaper":"종이","reader.themeDark":"어둡게","reader.emptyTitle":"문서를 선택하세요","reader.emptyHint":"텍스트는 이 기기에서 읽기 전용으로 열립니다.","reader.noDocuments":"지원되는 문서 없음","reader.scanning":"로컬 문서 검색 중…","reader.documentCount":"문서 {count}개 · 로컬 읽기 전용","reader.scanTruncated":"안전 검색 한도에 도달해 앞부분의 지원 문서만 표시합니다.","reader.folderUnavailable":"이 폴더를 사용할 수 없습니다. 다시 연결해 주세요.","reader.scanError":"이 폴더를 안전하게 검색할 수 없습니다.","reader.loading":"문서 여는 중…","reader.encodingError":"문서 인코딩을 안정적으로 식별할 수 없습니다.","reader.readError":"문서를 읽을 수 없습니다.","reader.invalidJson":"잘못된 JSON · 원본 텍스트 표시","reader.miniUnavailable":"Reader를 열기 전에 전체 보기로 돌아가세요.","player.folderUnsupported":"로컬 미디어 폴더 선택을 지원하지 않습니다.","player.noMusicFiles":"선택한 폴더에서 지원되는 오디오 또는 비디오 파일을 찾지 못했습니다.","player.videoBackground":"비디오 배경","player.videoBackgroundHint":"현재 비디오를 집중 화면 뒤에 표시합니다.","player.videoBadge":"비디오","player.mediaPlaybackError":"비디오가 손상되었거나 DRM으로 보호되었거나 디코딩할 수 없습니다.","player.videoDisplaySaveError":"비디오 표시 설정을 저장할 수 없습니다.","player.videoBackgroundEnabled":"현재 비디오를 배경에 표시합니다.","player.videoBackgroundDisabled":"현재 비디오는 오디오만 계속 재생합니다.","player.videoPreparing":"호환 사본 준비 중… {percent}%","player.clearVideoCache":"호환 캐시 지우기","player.videoCacheCleared":"비디오 호환 캐시를 지웠습니다."
  });
  Object.assign(SPANISH, {
    "common.cancel":"Cancelar","nav.read":"Leer","reader.open":"Abrir modo lectura","reader.close":"Cerrar modo lectura","reader.eyebrow":"Lector local","reader.title":"Modo lectura","reader.filter":"Filtrar documentos","reader.filterPlaceholder":"Filtrar por nombre…","reader.chooseFolder":"Elegir carpeta de lectura","reader.refresh":"Actualizar","reader.mediaFolder":"Carpeta multimedia actual","reader.readingFolder":"Carpeta de lectura","reader.findPlaceholder":"Buscar en el documento…","reader.textSize":"Tamaño del texto","reader.widthNarrow":"Estrecho","reader.widthMedium":"Medio","reader.widthWide":"Ancho","reader.themeAuto":"Automático","reader.themePaper":"Papel","reader.themeDark":"Oscuro","reader.emptyTitle":"Elige un documento","reader.emptyHint":"El texto permanece en este dispositivo y se abre en modo de solo lectura.","reader.noDocuments":"No hay documentos compatibles","reader.scanning":"Buscando documentos locales…","reader.documentCount":"{count} documentos · locales y de solo lectura","reader.scanTruncated":"Se alcanzó el límite de análisis seguro; se muestran los primeros documentos compatibles.","reader.folderUnavailable":"Esta carpeta no está disponible. Vuelve a conectarla para continuar.","reader.scanError":"No se pudo analizar esta carpeta de forma segura.","reader.loading":"Abriendo documento…","reader.encodingError":"No se pudo identificar la codificación con fiabilidad.","reader.readError":"No se pudo leer este documento.","reader.invalidJson":"JSON no válido · se muestra el texto original","reader.miniUnavailable":"Vuelve a la vista completa antes de abrir Reader.","player.folderUnsupported":"No se admite la selección de carpetas multimedia locales.","player.noMusicFiles":"No se encontraron archivos de audio o vídeo compatibles en la carpeta elegida.","player.videoBackground":"Vídeo de fondo","player.videoBackgroundHint":"Mostrar este vídeo detrás de la interfaz de concentración.","player.videoBadge":"Vídeo","player.mediaPlaybackError":"No se pudo reproducir el vídeo; puede estar dañado, protegido con DRM o no poder decodificarse.","player.videoDisplaySaveError":"No se pudo guardar la preferencia de visualización del vídeo.","player.videoBackgroundEnabled":"El vídeo actual se muestra como fondo.","player.videoBackgroundDisabled":"El vídeo actual continúa solo como audio.","player.videoPreparing":"Preparando una copia compatible… {percent} %","player.clearVideoCache":"Borrar caché de compatibilidad","player.videoCacheCleared":"Caché de compatibilidad de vídeo borrada."
  });
