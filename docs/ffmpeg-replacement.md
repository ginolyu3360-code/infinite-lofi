...
Date: 2026-09-25. This records the source-pinned replacement for the three FFmpeg executables bundled by Infinite Lo-Fi. It is a technical distribution review, **not legal advice**. The public v1.5.2 Release and its assets were not modified. The user separately authorized v1.5.3, which now contains these binaries and their corresponding source assets; qualified legal review remains advisable for future distribution decisions.
