...
当前已发布版本：**v1.1.0**。`main` 分支正在准备 **v1.2.0**（Phase 2）。安装包可从 [GitHub Releases](https://github.com/ginolyu3360-code/infinite-lofi/releases/latest) 下载；v1.2.0 起默认生成同时支持 Intel 与 Apple Silicon 的未签名 Universal 包。
...
Latest published release: **v1.1.0**. The `main` branch is preparing **v1.2.0** (Phase 2). Download releases from [GitHub Releases](https://github.com/ginolyu3360-code/infinite-lofi/releases/latest). Starting with v1.2.0, the default unsigned artifacts are Universal macOS builds for Intel and Apple Silicon.
