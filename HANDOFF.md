...
3. Continue normal delivery through a `codex/` branch, PR, passing macOS and Windows CI, squash merge, and exact-merge `main` CI. v1.5.3 was explicitly authorized and published; later versions still require separate direction.
...
- Public baseline: [v1.5.3](https://github.com/ginolyu3360-code/infinite-lofi/releases/tag/v1.5.3), tagged at `9e9246e39555d03b926bb9b165b4379eae4b215c` after release-preparation [PR #45](https://github.com/ginolyu3360-code/infinite-lofi/pull/45) and passing [exact-merge main CI 36116259249](https://github.com/ginolyu3360-code/infinite-lofi/actions/runs/36116259249). [Release workflow 36116663508](https://github.com/ginolyu3360-code/infinite-lofi/actions/runs/36116663508) passed and published unsigned macOS Universal DMG/ZIP, Windows x64 NSIS EXE, three corresponding FFmpeg source archives, and `SHA256SUMS.txt`.
- Historical v1.5.2 was delivered through [PR #42](https://github.com/ginolyu3360-code/infinite-lofi/pull/42) as `5f793aa4991ccd27b924373363f92395e855aeef`; its already-published binaries were not modified during the FFmpeg replacement or v1.5.3 release.
...
- `npm run start:local` checks the committed tree and local edits before opening a packaged app; `npm run ensure:local` updates it without opening. This is launch-time freshness, not an automatic post-commit build. The current local Universal package was verified against the v1.5.3 release commit's tree.
